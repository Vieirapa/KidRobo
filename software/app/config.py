...
AUDIO_FALLBACK_SAMPLE_RATES = (48000, 32000, 16000, 8000)
AUDIO_CHANNELS = 1
AUDIO_RECORD_SECONDS = 10
AUDIO_PRE_ROLL_SECONDS = 0.4
AUDIO_SILENCE_THRESHOLD = 0.025
...
DISPLAY_FRAME_DELAY_STANDBY_SECONDS = 0.9
DISPLAY_FRAME_DELAY_WAITING_SECONDS = 0.45
DISPLAY_FRAME_DELAY_TALKING_SECONDS = 0.22
DISPLAY_FRAME_DELAY_HAPPY_SECONDS = 0.3
DISPLAY_ANIMATE_CYCLES_STANDBY = 2
DISPLAY_ANIMATE_CYCLES_WAITING = 2
DISPLAY_ANIMATE_CYCLES_TALKING = 6
DISPLAY_ANIMATE_CYCLES_HAPPY = 3
STANDBY_POLL_SECONDS = 0.7
TOUCH_ENABLED = True
TOUCH_DEVICE_PATH = ""
TOUCH_DEBOUNCE_SECONDS = 0.35
